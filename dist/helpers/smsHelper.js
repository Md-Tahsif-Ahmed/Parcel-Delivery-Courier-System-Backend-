...
class TwilioService {
    constructor() {
        ...
        if (!accountSid || !authToken) {
            throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, "Twilio credentials are not configured. Please set TWILIO_ACCOUNT_SID and TWILIO_AUTH_TOKEN in environment");
        }
    ...
    sendOTPWithVerify(phoneNumber, countryCode) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const serviceSid = config_1.default.twilio.serviceSid;
                console.log("Service SID:", serviceSid);
                console.log("TWILIO_ACCOUNT_SID:", config_1.default.twilio.accountSid ? "OK" : "Missing");
                console.log("TWILIO_AUTH_TOKEN:", config_1.default.twilio.authToken ? "OK" : "Missing");
                console.log("TWILIO_SERVICE_SID:", config_1.default.twilio.serviceSid ? "OK" : "Missing");
                if (!serviceSid) {
                    throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, "Twilio Verify Service SID is not configured. Please set TWILIO_SERVICE_SID in environment");
                }
                ...
                const errMsg = (error && error.message) || "Failed to send verification code";
                throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.EXPECTATION_FAILED, `Failed to send verification code: ${errMsg}`);
            }
        });
    }
    // Verify the OTP
