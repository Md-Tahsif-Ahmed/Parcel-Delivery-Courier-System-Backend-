...
export const DeliveryController = {
  ...
  changeOffer: catchAsync(async (req, res) => {
  const result = await DeliveryService.changeDeliveryOfferToDB(
    req.user as JwtPayload,
    req.params.id,
    req.body.customerOfferFare,
  );

  sendResponse(res, {
    success: true,
    statusCode: StatusCodes.OK,
    message: "Delivery offer updated successfully",
    data: result,
  });
}),
